...
#define GFXMMU_VIRTUAL_BUFFER0_BASE 0xd0000000
/* USER CODE END 0 */
...
void MX_LTDC_Init(void)
{
  ...
  hltdc.Init.HorizontalSync = 127-4;
  hltdc.Init.VerticalSync = 3-1;
  hltdc.Init.AccumulatedHBP = 215+4;
  hltdc.Init.AccumulatedVBP = 26+1;
